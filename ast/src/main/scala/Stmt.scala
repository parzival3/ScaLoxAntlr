...
case class LoxClass(name: TokenInstance, superclass: Option[TokenInstance], methods: List[Stmt]) extends Stmt
...
case class Function(name: TokenInstance, params: List[TokenInstance], body: List[Stmt]) extends Stmt
